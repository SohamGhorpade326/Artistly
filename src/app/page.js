...
export default function Home() {
  return (
    <div className="min-h-screen bg-yellow-50 dark:bg-gray-900 text-black dark:text-white space-y-10 text-center p-4">
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-6xl mx-auto">
        <div className="p-4 border bg-white-50 rounded shadow hover:scale-105 transition">
          ...
          <p className="text-gray-600 dark:text-gray-300">Find soulful soloists and energetic bands for your event.</p>
        </div>
        ...
        <div className="p-4 border rounded shadow hover:scale-105 transition">
          ...
          <p className="text-gray-600 dark:text-gray-300">Book captivating dance groups and solo performers.</p>
        </div>
        ...
        <div className="p-4 border rounded shadow hover:scale-105 transition">
          ...
          <p className="text-gray-600 dark:text-gray-300">Hire professional DJs to set the perfect vibe.</p>
        </div>
      </section>
